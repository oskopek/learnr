...
* Download a sample dataset from the https://github.com/oskopek/learnr/data/import_export[GitHub repository's data folder]
...
See https://github.com/oskopek/learnr/data[the GitHub repository data] folder for more information.
